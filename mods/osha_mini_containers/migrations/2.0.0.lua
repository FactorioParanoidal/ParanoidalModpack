for i, force in pairs(game.forces) do 
    ...
    if force.technologies["logistic-system"].researched then 
        force.recipes["mini-logistic-chest-active-provider"].enabled = true
        force.recipes["mini-logistic-chest-buffer"].enabled = true
        force.recipes["mini-logistic-chest-requester"].enabled = true
    end
end
