...
if setting and setting.value == true then
	...
	local water_pumpjack_2 =
	{
		...
		effects =
		{
			...
			{type="unlock-recipe", recipe="water-miner-2"}
		}
	...
	local water_pumpjack_3 =
	{
		...
		effects =
		{
			...
			{type="unlock-recipe", recipe="water-miner-3"}
		},
	...
	local water_pumpjack_4 =
	{
		...
		effects =
		{
			...
			{type="unlock-recipe", recipe="water-miner-4"}
		},
	...
	local water_pumpjack_5 =
	{
		...
		effects =
		{
			...
			{type="unlock-recipe", recipe="water-miner-5"}
		}
