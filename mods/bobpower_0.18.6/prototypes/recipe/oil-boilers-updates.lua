...
elseif data.raw.item["tungsten-pipe"] then
  ...
  if settings.startup["bobmods-plates-convert-recipes"] and settings.startup["bobmods-plates-convert-recipes"].value == true then
    ...
    bobmods.lib.tech.add_recipe_unlock("bob-boiler-2", "boiler-2-from-oil-boiler")
    bobmods.lib.tech.add_recipe_unlock("bob-boiler-3", "boiler-3-from-oil-boiler-2")
    bobmods.lib.tech.add_recipe_unlock("bob-boiler-4", "boiler-4-from-oil-boiler-3")
    bobmods.lib.tech.add_recipe_unlock("bob-boiler-5", "boiler-5-from-oil-boiler-4")
  end
