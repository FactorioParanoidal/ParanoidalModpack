	...
	return
	{
		layers =
		{
			...
			},
			{
				...
				{
					{
						filename = "__scattergun_turret__/graphics/entity/dcannon-turret/dcannon-turret-gun-1.png",
          					width_in_frames = inputs.frame_count or 1,
						height_in_frames = 9
					},
					{
						filename = "__scattergun_turret__/graphics/entity/dcannon-turret/dcannon-turret-gun-2.png",
          					width_in_frames = inputs.frame_count or 1,
						height_in_frames = 9
					},
					{
						filename = "__scattergun_turret__/graphics/entity/dcannon-turret/dcannon-turret-gun-3.png",
          					width_in_frames = inputs.frame_count or 1,
						height_in_frames = 9
					},
					{
						filename = "__scattergun_turret__/graphics/entity/dcannon-turret/dcannon-turret-gun-4.png",
          					width_in_frames = inputs.frame_count or 1,
						height_in_frames = 9
					},
				},
