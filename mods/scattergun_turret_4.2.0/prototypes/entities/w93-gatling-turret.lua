	...
	return
	{
		layers =
		{
			...
			},
			{
				...
				{
					{
						filename = "__scattergun_turret__/graphics/entity/gatling-turret/gatling-turret-gun-1.png",
          					width_in_frames = inputs.frame_count or 1,
						height_in_frames = 18
					},
					{
						filename = "__scattergun_turret__/graphics/entity/gatling-turret/gatling-turret-gun-2.png",
          					width_in_frames = inputs.frame_count or 1,
						height_in_frames = 18
					},
				},
