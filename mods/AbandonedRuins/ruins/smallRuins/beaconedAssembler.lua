return
{
  entities =
  {
    {"bulk-inserter", {x = -0.5, y = -2.5}, {dir = "west", dmg = {dmg = {type = "random", min = 1, max = 75}}, dead = 0.2}},
    {"steel-chest", {x = -1.5, y = -2.5}, {dmg = {dmg = {type = "random", min = 1, max = 75}}, dead = 0.2}},
    {"medium-electric-pole-remnants", {x = 1.5, y = -3.5}, {}},
    {"bulk-inserter", {x = 2.5, y = -3.5}, {dir = "south", dmg = {dmg = {type = "random", min = 1, max = 75}}, dead = 0.2}},
    {"bulk-inserter", {x = 3.5, y = -2.5}, {dir = "east", dmg = {dmg = {type = "random", min = 1, max = 75}}, dead = 0.2}},
