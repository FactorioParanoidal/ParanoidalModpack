								...
								target_effects =
									{
										{
											type = "damage",
											damage = { amount = attributes.fireDamagePerTick or 45/10, type = attributes.fireDamagePerTickType or "fire" }
										}
									}
							}
					},
								...
								target_effects =
									{
										{
											type = "damage",
											damage = {amount = (attributes.fireDamagePerTick or (45/60)), type = attributes.fireDamagePerTickType or "fire" }
										}
									}
							}
					},
                        ...
                        target_effects =
                            {
                                ...
                                {
                                    type = "damage",
                                    damage = { amount = (attributes.damagePerTick or 0)*10, type = attributes.damageType or "acid" }		-- hit 6 times per sec (can't be changed)
                                }
                            }
                    }
            },
...
safeFireOnTree.damage_per_tick = {amount = 0, type = "fire"}
...
function fireUtils.makeAcidFireStream()
	...
	acidFireSticker.damage_interval = 10
	acidFireSticker.damage_per_tick = { amount = 200 / 60, type = "fire" }
	data:extend(
		{acidFireSticker}
	)
