    ...
    data:extend({
            {
                ...
                life_time = 240,
                pictures = particle_animations.get_blood_particle_pictures({tint = tint, scale = 1, shift = util.by_pixel (0,0)}),
                shadows = particle_animations.get_blood_particle_pictures({tint = {r=tint.r*0.1, b=tint.b*0.1, g=tint.g*0.1, a=tint.a*0.1}, scale = 1, shift = util.by_pixel (1,0)}),
