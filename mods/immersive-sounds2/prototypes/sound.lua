...
-- 2.0: рельсы переработаны (curved-rail → curved-rail-a/-b + half-diagonal-rail)
data.raw["straight-rail"]["straight-rail"].walking_sound = rail_walk_over_sound
data.raw["half-diagonal-rail"]["half-diagonal-rail"].walking_sound = rail_walk_over_sound
data.raw["curved-rail-a"]["curved-rail-a"].walking_sound = rail_walk_over_sound
data.raw["curved-rail-b"]["curved-rail-b"].walking_sound = rail_walk_over_sound
...
-- 2.0: камни переименованы (rock-big→big-rock, rock-huge→huge-rock, sand-rock-big→big-sand-rock)
