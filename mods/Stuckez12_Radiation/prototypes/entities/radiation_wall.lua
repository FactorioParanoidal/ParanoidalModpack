...
radiation_wall.name                                        = "stkz-radiation-wall"
radiation_wall.minable.result                              = "stkz-radiation-wall"
...
data:extend({
    {
        ...
        order = "a[stone-wall]-b[stkz-radiation-wall]",
        ...
        place_result = "stkz-radiation-wall",
        stack_size = 100,
        hidden = true
    },
    {
        ...
        results = {
            { type = "item", name = "stkz-radiation-wall", amount = 1 }
        }
    }
})
