-- local pld_ammo_category = settings.startup["tankplatoon-personal-laser-defense-equipment-ammo-category"].value
-- if pld_ammo_category:match("[^electric]") then
--   local pld_eqp = data.raw["active-defense-equipment"]["personal-laser-defense-equipment"]
--   pld_eqp.attack_parameters.damage_modifier = 4 --15
--   pld_eqp.attack_parameters.ammo_type.category = pld_ammo_category --"electric"
-- end

data.raw["active-defense-equipment"]["personal-laser-defense-equipment"].attack_parameters.ammo_type.energy_consumption = settings.startup["tankplatoon-personal-laser-defense-equipment-energy-consumption"].value --"50kJ"

data.raw["active-defense-equipment"]["discharge-defense-equipment"].automatic = settings.startup["tankplatoon-discharge-defense-equipment-automatic"].value
...
data:extend
{
  ...
  -- Vehicle Energy Shield
  {
    ...
    sprite =
    {
      filename = "__SchallTankPlatoon__/graphics/equipment/vehicle-energy-shield-equipment.png",
      width = 128,
      height = 128,
      priority = "medium"
    },
  ...
  },
  {
    ...
    sprite =
    {
      filename = "__SchallTankPlatoon__/graphics/equipment/vehicle-energy-shield-mk2-equipment.png",
      width = 128,
      height = 128,
      priority = "medium"
    },
...
if settings.startup["tankplatoon-vehicle-battery-enable"].value then
  drbe = data.raw["battery-equipment"]
  if drbe["battery-equipment"] then
    drbe["battery-equipment"].sprite = { filename = "__SchallTankPlatoon__/graphics/equipment/battery-equipment.png", width = 32, height = 64, priority = "medium" }
  end
  if drbe["battery-mk2-equipment"] then
    drbe["battery-mk2-equipment"].sprite = { filename = "__SchallTankPlatoon__/graphics/equipment/battery-mk2-equipment.png", width = 32, height = 64, priority = "medium" }
  end
end
