function W93_UpdateRecipesKrastorio2()
	...
	data.raw["recipe"]["w93-modular-gun-tlaser"].ingredients = {{"plastic-bar", 8}, {"steel-plate", 2}, {"processing-unit", 2}, {"lithium-sulfur-battery", 10}, {"imersite-crystal", 5}, {"effectivity-module", 1}}
