...
local heavy_loco = flib.copy_prototype(data.raw["item-with-entity-data"]["locomotive"], "heavy-locomotive")
heavy_loco.icon = "__TrainOverhaul__/graphics/icons/heavy-locomotive.png"
heavy_loco.order = "a[train-system]-fc[locomotive]"

local express_loco = flib.copy_prototype(data.raw["item-with-entity-data"]["locomotive"], "express-locomotive")
express_loco.icon = "__TrainOverhaul__/graphics/icons/express-locomotive.png"
express_loco.order = "a[train-system]-fd[locomotive]"

local nuclear_loco = flib.copy_prototype(data.raw["item-with-entity-data"]["locomotive"], "nuclear-locomotive")
...
local heavy_cargo_wagon = flib.copy_prototype(data.raw["item-with-entity-data"]["cargo-wagon"], "heavy-cargo-wagon")
...
local heavy_fluid_wagon = flib.copy_prototype(data.raw["item-with-entity-data"]["fluid-wagon"], "heavy-fluid-wagon")
...
local express_cargo_wagon = flib.copy_prototype(data.raw["item-with-entity-data"]["cargo-wagon"], "express-cargo-wagon")
...
local express_fluid_wagon = flib.copy_prototype(data.raw["item-with-entity-data"]["fluid-wagon"], "express-fluid-wagon")
