...
table.insert(data.raw.technology["weapon-shooting-speed-3"].effects,{type = "gun-speed", ammo_category = "laser-rifle", modifier = 0.3})
table.insert(data.raw.technology["weapon-shooting-speed-4"].effects,{type = "gun-speed", ammo_category = "laser-rifle", modifier = 0.3})
table.insert(data.raw.technology["weapon-shooting-speed-5"].effects,{type = "gun-speed", ammo_category = "laser-rifle", modifier = 0.4})
table.insert(data.raw.technology["weapon-shooting-speed-6"].effects,{type = "gun-speed", ammo_category = "laser-rifle", modifier = 0.5})
...
bobmods.lib.tech.remove_science_pack("laser-turret-speed-1", "chemical-science-pack")
bobmods.lib.tech.remove_science_pack("laser-turret-speed-2", "chemical-science-pack")
...
bobmods.lib.tech.remove_science_pack("laser-turrets", "chemical-science-pack")
