    ...
    data:extend(
    {
      ...
      },
      {
        ...
        results =
        {
          ...
          {type="item", name="lead-plate", amount=10, catalyst_amount=10},
...
if settings.startup["bobmods-plates-bluedeuterium"].value == true then
  ...
  if settings.startup["bobmods-plates-nuclearupdate"].value == true then
    data.raw.recipe["deuterium-fuel-reprocessing"].icon = "__bobplates__/graphics/icons/nuclear/deuterium-nuclear-fuel-reprocessing-blue-new.png"
  else
