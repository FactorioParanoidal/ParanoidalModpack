if settings.startup["bobmods-logistics-inserteroverhaul"].value == true then
  ...
  if data.raw.item["cobalt-steel-bearing"] then
    ...
    if settings.startup["bobmods-logistics-inserterrequireprevious"].value == true then
      bobmods.lib.recipe.add_ingredient("fast-inserter", { "cobalt-steel-bearing", 1 })
      bobmods.lib.recipe.add_ingredient("bulk-inserter", { "cobalt-steel-bearing", 5 })
  ...
  elseif data.raw.item["brass-bearing"] then
    ...
    if settings.startup["bobmods-logistics-inserterrequireprevious"].value == true then
      bobmods.lib.recipe.add_ingredient("fast-inserter", { "brass-bearing", 1 })
      bobmods.lib.recipe.add_ingredient("bulk-inserter", { "brass-bearing", 5 })
  ...
  elseif data.raw.item["steel-bearing"] then
    ...
    if settings.startup["bobmods-logistics-inserterrequireprevious"].value == true then
      ...
      bobmods.lib.recipe.add_ingredient("bulk-inserter", { "steel-bearing", 5 })
    end
  end
  ...
  if data.raw.item["titanium-bearing"] then
    ...
    if settings.startup["bobmods-logistics-inserterrequireprevious"].value == true then
      ...
      bobmods.lib.recipe.add_ingredient("turbo-bulk-inserter", { "titanium-bearing", 6 })
      bobmods.lib.recipe.add_ingredient("turbo-stack-filter-inserter", { "titanium-bearing", 6 })
    else
      bobmods.lib.recipe.add_ingredient("turbo-bulk-inserter", { "titanium-bearing", 5 })
    end
  end
  ...
  if data.raw.item["nitinol-bearing"] then
    ...
    if settings.startup["bobmods-logistics-inserterrequireprevious"].value == true then
      ...
      bobmods.lib.recipe.add_ingredient("express-bulk-inserter", { "nitinol-bearing", 6 })
      bobmods.lib.recipe.add_ingredient("express-stack-filter-inserter", { "nitinol-bearing", 6 })
    else
      bobmods.lib.recipe.add_ingredient("express-bulk-inserter", { "nitinol-bearing", 5 })
    end
  end
  ...
  if data.raw.item["titanium-bearing"] then
    ...
    bobmods.lib.recipe.add_ingredient("express-bulk-inserter", { "titanium-bearing", 6 })
