		...
		},
		{
			...
			normal = {
				...
				ingredients = {
					...
					{type = "item", name = "t3-pipe", amount = 40},
					{type = "item", name = "t3-brick", amount = 50},
					{type = "item", name = "t3-gears", amount = 16}
				},
			...
			expensive = {
				...
				ingredients = {
					{type = "item", name = "thermal-1", amount = 1},
					{type = "item", name = "t4-plate", amount = 60 * buildingmulti},
					{type = "item", name = "t4-circuit", amount = 4 * buildingmulti},
					{type = "item", name = "t4-pipe", amount = 40 * buildingmulti},
					{type = "item", name = "t4-brick", amount = 50 * buildingmulti},
					{type = "item", name = "t4-gears", amount = 16 * buildingmulti}
				},
				result = "thermal-extractor"
			}
		},
