...
data.raw.inserter["express-stack-inserter"].hand_closed_picture = inserter.graphics.dark_green.stack.hand_closed_picture()
...
data.raw.inserter["express-stack-filter-inserter"].hand_closed_picture = inserter.graphics.stripe.stack.hand_closed_picture()
data.raw.inserter["express-stack-filter-inserter"].hand_open_picture = inserter.graphics.stripe.stack.hand_open_picture()
