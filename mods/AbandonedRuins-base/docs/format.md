...
This is an non-working example. Please refer to mod `AbandonedRuins-base` and `realistic-ruins-updated` for live and playable mods.

```lua
error("This is an non-working example. Please refer to mod 'AbandonedRuins-base' and 'realistic-ruins-updated' for live and playable mods.")
return
{
  variables = {
