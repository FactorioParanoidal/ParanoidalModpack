...
bobmods.lib.tech.add_recipe_unlock("advanced-oil-processing", "solid-fuel-from-light-oil")
bobmods.lib.tech.add_recipe_unlock("advanced-oil-processing", "solid-fuel-from-heavy-oil")
