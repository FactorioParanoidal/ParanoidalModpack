local ATTP_PREREQUISITES = { "circuit-network",
	"fluid-handling",
	"fluid-wagon",
	"gate",
	"fast-inserter",
...
local ATTP_2_PREREUISITES = { ATTP_1_TECHNOLOGY_NAME,
	"logistics-2",
	"logistic-science-pack",
	"automation-2",
	"gun-turret"
}
local ATTP_3_PREREQUISITES = { ATTP_2_TECHNOLOGY_NAME,
	"warehouse-research",
	"utility-science-pack",
	"logistics-3",
	"automation-3"
}
local ATTP_4_PREREQUISITES = { ATTP_3_TECHNOLOGY_NAME,
	"utility-science-pack",
