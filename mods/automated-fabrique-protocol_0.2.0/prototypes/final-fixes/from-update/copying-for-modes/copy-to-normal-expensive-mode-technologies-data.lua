local technology_data_field_names = { "upgrade",
    "enabled",
    "hidden",
...
local function clearTechnologyData(technology)
    _table.each(technology_data_field_names,
    ...
    function(mode)
        ...
        _table.each(technology_names,
            function(technology_name)
                ...
                log('for mode ' .. mode .. ' technology named ' ..
                    technology_name .. ' is after copying for modes ' .. Utils.dump_to_console(technology))
            end)
    end)
