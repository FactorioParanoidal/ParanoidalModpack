if bobmods.plates and settings.startup["bobmods-revamp-rtg"].value == true then
  ...
  if settings.startup["bobmods-revamp-hardmode"].value == true then
    ...
    bobmods.lib.recipe.add_result("sodium-carbonate", {type = "fluid", name = "pure-water", amount = 10, fluidbox_index = 1})
    ...
    bobmods.lib.tech.add_recipe_unlock("electrolysis-2", "brine-electrolysis")
    ...
    bobmods.lib.module.add_productivity_limitation("ammonium-chloride-recycling")
  end
