...
--chemical plants
data.raw["assembling-machine"]["chemical-plant"].working_visualisations.light=
	  {
...
if data.raw["assembling-machine"]["chemical-plant-2"] then
	 data.raw["assembling-machine"]["chemical-plant-2"].working_visualisations.light=
	  {
...
if data.raw["assembling-machine"]["chemical-plant-3"] then
	 data.raw["assembling-machine"]["chemical-plant-3"].working_visualisations.light=
	  {
...
if data.raw["assembling-machine"]["chemical-plant-4"] then
	 ...
	 data.raw["assembling-machine"]["chemical-plant-4"].working_visualisations.light=
	  {
