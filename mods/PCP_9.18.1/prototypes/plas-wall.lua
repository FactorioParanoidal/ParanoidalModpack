function plas_wall_images()
  return
    {single =
    {
      ...
      {
        {
          filename = "__PCP__/graphics/plastic-wall/wall-single.png",
          priority = "extra-high",
          width = 32,
          height = 46,
          variation_count = 2,
          ...
          hr_version =
          {
            filename = "__PCP__/graphics/plastic-wall/hr-wall-single.png",
            priority = "extra-high",
            width = 64,
            height = 86,
            variation_count = 2,
    ...
    straight_vertical =
    {
      ...
      {
        {
          filename = "__PCP__/graphics/plastic-wall/wall-vertical.png",
          priority = "extra-high",
          width = 32,
          height = 68,
          variation_count = 5,
          ...
          hr_version =
          {
            filename = "__PCP__/graphics/plastic-wall/hr-wall-vertical.png",
            priority = "extra-high",
            width = 64,
            height = 134,
            variation_count = 5,
    ...
    straight_horizontal =
    {
      ...
      {
        {
          filename = "__PCP__/graphics/plastic-wall/wall-horizontal.png",
          priority = "extra-high",
          width = 32,
          height = 50,
          variation_count = 6,
          ...
          hr_version =
          {
            filename = "__PCP__/graphics/plastic-wall/hr-wall-horizontal.png",
            priority = "extra-high",
            width = 64,
            height = 92,
            variation_count = 6,
    ...
    corner_right_down =
    {
      ...
      {
        {
          filename = "__PCP__/graphics/plastic-wall/wall-corner-right.png",
          priority = "extra-high",
          width = 32,
          height = 64,
          variation_count = 2,
          ...
          hr_version =
          {
            filename = "__PCP__/graphics/plastic-wall/hr-wall-corner-right.png",
            priority = "extra-high",
            width = 64,
            height = 128,
            variation_count = 2,
    ...
    corner_left_down =
    {
      ...
      {
        {
          filename = "__PCP__/graphics/plastic-wall/wall-corner-left.png",
          priority = "extra-high",
          width = 32,
          height = 68,
          variation_count = 2,
          ...
          hr_version =
          {
            filename = "__PCP__/graphics/plastic-wall/hr-wall-corner-left.png",
            priority = "extra-high",
            width = 64,
            height = 134,
            variation_count = 2,
    ...
    t_up =
    {
      ...
      {
        {
          filename = "__PCP__/graphics/plastic-wall/wall-t.png",
          priority = "extra-high",
          width = 32,
          height = 68,
          variation_count = 4,
          ...
          hr_version =
          {
            filename = "__PCP__/graphics/plastic-wall/hr-wall-t.png",
            priority = "extra-high",
            width = 64,
            height = 134,
            variation_count = 4,
    ...
    ending_right =
    {
      ...
      {
        {
          filename = "__PCP__/graphics/plastic-wall/wall-ending-right.png",
          priority = "extra-high",
          width = 32,
          height = 48,
          variation_count = 2,
          ...
          hr_version =
          {
            filename = "__PCP__/graphics/plastic-wall/hr-wall-ending-right.png",
            priority = "extra-high",
            width = 64,
            height = 92,
            variation_count = 2,
    ...
    ending_left =
    {
      ...
      {
        {
          filename = "__PCP__/graphics/plastic-wall/wall-ending-left.png",
          priority = "extra-high",
          width = 32,
          height = 48,
          variation_count = 2,
          ...
          hr_version =
          {
            filename = "__PCP__/graphics/plastic-wall/hr-wall-ending-left.png",
            priority = "extra-high",
            width = 64,
            height = 92,
            variation_count = 2,
    ...
    filling =
    {
      filename = "__PCP__/graphics/plastic-wall/wall-filling.png",
        priority = "extra-high",
        width = 24,
        height = 30,
        variation_count = 8,
        ...
        hr_version =
        {
          filename = "__PCP__/graphics/plastic-wall/hr-wall-filling.png",
          priority = "extra-high",
          width = 48,
          height = 56,
          variation_count = 8,
    ...
    water_connection_patch =
    {
      ...
      {
        {
          filename = "__PCP__/graphics/plastic-wall/wall-patch.png",
          priority = "extra-high",
          width = 58,
          height = 64,
          shift = util.by_pixel(0, -2),
          hr_version =
          {
            filename = "__PCP__/graphics/plastic-wall/hr-wall-patch.png",
            priority = "extra-high",
            width = 116,
            height = 128,
            shift = util.by_pixel(0, -2),
    ...
    gate_connection_patch =
    {
      ...
      {
        {
          filename = "__PCP__/graphics/plastic-wall/wall-gate.png",
          priority = "extra-high",
          width = 42,
          height = 56,
          shift = util.by_pixel(0, -8),
          hr_version =
          {
            filename = "__PCP__/graphics/plastic-wall/hr-wall-gate.png",
            priority = "extra-high",
            width = 82,
            height = 108,
            shift = util.by_pixel(0, -7),
