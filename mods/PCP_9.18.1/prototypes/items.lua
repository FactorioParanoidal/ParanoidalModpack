data:extend({
  ...
  --rubbers
  {
    ...
    icon="__PCP__/graphics/icons/solid-rubber-additive.png",
    icon_size = 64,
  ...
  },
  {
    ...
    icon="__PCP__/graphics/icons/solid-rubber-block.png",
    icon_size = 64,
    subgroup = "petrochem-solids",
  ...
  },
  {
    ...
    icon="__PCP__/graphics/icons/solid-rubber-slab.png",
    icon_size = 64,
    subgroup = "petrochem-solids",
    order = "f[rubber-slab]",
    stack_size = 100
  },
  {
    ...
    icon="__PCP__/graphics/icons/solid-rubber-pellet.png",
    icon_size = 64,
    subgroup = "petrochem-solids",
  ...
  },
  {
    ...
    icon="__PCP__/graphics/icons/solid-rubber-powder.png",
    icon_size = 64,
    subgroup = "petrochem-solids",
  ...
  },
  {
    ...
    icon="__PCP__/graphics/icons/solid-rubber-waste.png",
    icon_size = 64,
    subgroup= "petrochem-solids",
  ...
  },
  {
    ...
    icons={{icon = "__PCP__/graphics/icons/roll-blank.png", tint = {r = 0, g = 0, b = 0},icon_size=32}},
    subgroup = "petrochem-solids",
    order = "ya",
    stack_size = 200
  },
