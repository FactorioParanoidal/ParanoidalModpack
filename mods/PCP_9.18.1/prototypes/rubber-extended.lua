...
data:extend({
  --rubber additive 1 (5 carbon->2rubber additive) 0.5
  {
    ...
    icons ={
      {icon="__PCP__/graphics/icons/solid-rubber-additive.png",icon_size = 64},
      {
  ...
  --4rubber coil->16rubber -1assembly (allow prod) 0.5
  {
    ...
    icons = {
      ...
      {
        icon = "__PCP__/graphics/icons/roll-blank.png",
  ...
  --6rubber slab->24rubber pellets+1spent rubber -3pellet press 0.25
  {
    ...
    order = "ya",
    icons={{icon="__PCP__/graphics/icons/solid-rubber-pellet.png",icon_size = 64,}},
  },
  --(1)sawblade+11rubber block->33rubber slab+sawblade(0.9) -1assembly 0.5
  {
    type = "recipe",
    ...
    order = "ya",
    icons={{ icon="__PCP__/graphics/icons/solid-rubber-slab.png",icon_size = 64,}},
  },
  --45pre-rubber+160water->5rubber block -2chemplant 1
  {
    type = "recipe",
