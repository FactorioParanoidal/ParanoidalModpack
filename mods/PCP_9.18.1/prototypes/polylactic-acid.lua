...
data:extend({
	{
		...
		icon="__PCP__/graphics/icons/bacterial-mother-2.png",
		icon_size = 64,
	...
	},
	{
		...
		icons = {
			{
				icon = "__PCP__/graphics/icons/poly-lactic-acid-plastic.png",
			},
		},
		icon_size = 32,
	},
	{
		...
		icons= {
			{
				icon="__PCP__/graphics/icons/bacterial-mother-1.png",
				icon_size=64,
			},
		},
		icon_size=32,
