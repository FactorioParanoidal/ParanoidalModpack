...
if assembling_machine["chemical-plant"] then 
  assembling_machine["chemical-plant"].module_specification = 
  {
      module_slots = 1,
      module_info_icon_shift = {0, 0.5},
      module_info_multi_row_initial_height_modifier = -0.3
...
if assembling_machine["chemical-plant-2"] then 
  assembling_machine["chemical-plant-2"].module_specification = 
  {
      module_slots = 2,
      module_info_icon_shift = {0, 0.5},
      module_info_multi_row_initial_height_modifier = -0.3
...
if assembling_machine["chemical-plant-3"] then 
  assembling_machine["chemical-plant-3"].module_specification = 
  {
      module_slots = 3,
      module_info_icon_shift = {0, 0.5},
      module_info_multi_row_initial_height_modifier = -0.3
...
if assembling_machine["chemical-plant-4"] then 
  assembling_machine["chemical-plant-4"].module_specification = 
  {
      module_slots = 4,
      module_info_icon_shift = {0, 0.5},
      module_info_multi_row_initial_height_modifier = -0.3
