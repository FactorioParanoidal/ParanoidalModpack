...
if OSM.data_stage and OSM.data_stage == 0 then
	...
	-- Extend data-utils functions to OSM.utils
	...
	-- Handy stuff
	OSM.dictionary = require("core.data-types")			--[[contains all data.raw prototype subtypes]]
