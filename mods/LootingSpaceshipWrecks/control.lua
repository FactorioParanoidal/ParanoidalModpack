...
local function add(collection, list)
  for name, value in pairs(list) do
    ...
    if prototypes.item[name] then
      ...
      -- Freeplay discarded unavailable items in Beta 8 too; do not invent replacements.
...
script.on_init(function()
  ...
  if freeplay and freeplay.get_created_items and freeplay.set_created_items
    and freeplay.get_ship_items and freeplay.set_ship_items
    and freeplay.get_debris_items and freeplay.set_debris_items
    and settings.global["lootingspaceshipwrecks-bonus-start-items"].value then
