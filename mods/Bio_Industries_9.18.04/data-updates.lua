...
if BI.Settings.BI_Solar_Additions then
        ...
        if data.raw.item["tinned-copper-cable"] then
                ...
                thxbob.lib.recipe.add_new_ingredient ("bi-wooden-pole-huge", {type = "item", name = "tinned-copper-cable", amount = 15})
        ...
        if data.raw.item["solar-panel-large"] then
                ...
                thxbob.lib.recipe.add_new_ingredient ("bi-bio-solar-farm", {type = "item", name = "solar-panel-large", amount = 30})
        ...
        if data.raw.item["substation-3"] then
                ...
                thxbob.lib.recipe.add_new_ingredient ("bi-large-substation", {type = "item", name = "substation-3", amount = 6})
        ...
        if data.raw.item["electrum-alloy"] then
                ...
                thxbob.lib.recipe.add_new_ingredient ("bi-large-substation", {type = "item", name = "electrum-alloy", amount = 10})
        ...
        if data.raw.item["large-accumulator-2"] then
                ...
                thxbob.lib.recipe.add_new_ingredient ("bi-bio-accumulator", {type = "item", name = "large-accumulator", amount = 30})
        ...
        if data.raw.item["aluminium-plate"] then
                ...
                thxbob.lib.recipe.add_new_ingredient ("bi-bio-accumulator", {type = "item", name = "aluminium-plate", amount = 50})
        ...
        if data.raw.item["aluminium-plate"] then
                ...
                thxbob.lib.recipe.add_new_ingredient ("bi-solar-mat", {type = "item", name = "aluminium-plate", amount = 1})
        ...
        if data.raw.item["silicon-wafer"] then
                ...
                thxbob.lib.recipe.add_new_ingredient ("bi-solar-mat", {type = "item", name = "silicon-wafer", amount = 4})
        ...
        if data.raw.item["angels-electric-boiler"] then
                ...
                thxbob.lib.recipe.add_new_ingredient ("bi-solar-boiler-panel", {type = "item", name = "angels-electric-boiler", amount = 1})
