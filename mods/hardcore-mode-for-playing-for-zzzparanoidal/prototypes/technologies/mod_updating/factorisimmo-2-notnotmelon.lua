...
local function update_factorissimo_mod(mode)
	...
	tech_util.add_prerequisites_to_technology(technologies["military-science-pack"], { "factory-architecture-t2" }, mode)
	tech_util.add_prerequisites_to_technology(technologies["chemical-science-pack"], { "factory-architecture-t2" }, mode)
	tech_util.add_prerequisites_to_technology(technologies["production-science-pack"], { "factory-recursion-t1" }, mode)
	tech_util.add_prerequisites_to_technology(technologies["factory-connection-type-heat"], { "bob-heat-pipe-1" }, mode)
	...
	tech_util.add_prerequisites_to_technology(technologies["space-science-pack"], { "factory-recursion-t2" }, mode)
end
