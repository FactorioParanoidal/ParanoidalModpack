...
local resistances = {{type = "fire", percent = 90}}
...
local unpowered_pump_template =
{
	...
	order = "8", -- yeah, it's a dick bitch!
...
local burner_pump_template =
{
	...
	-- Template unique properties
	energy_source = {type = "burner", fuel_category = "chemical", effectivity = 0.5, fuel_inventory_size = 1, emissions_per_minute = 10},
...
if settings.startup ["enable-power"].value == true then
	...
	offshore_placeholder_0.minable = {mining_time = 3, result = "offshore-pump-0"}
	...
	offshore_placeholder_1.minable = {mining_time = 3, result = "offshore-pump-1"}
	offshore_placeholder_1.max_health = 150
	offshore_placeholder_1.pumping_speed = 5
	...
	offshore_pump_1.minable = {mining_time = 3, result = "offshore-pump-1"}
	offshore_pump_1.placeable_by = {item = "offshore-pump-1", count = 1}
	offshore_pump_1.max_health = 150
	offshore_pump_1.crafting_speed = 1
	offshore_pump_1.energy_usage = "740kW"
	...
	offshore_placeholder_2.minable = {mining_time = 3, result = "offshore-pump-2"}
	offshore_placeholder_2.max_health = 200
	offshore_placeholder_2.pumping_speed = 10
	...
	offshore_pump_2.minable = {mining_time = 3, result = "offshore-pump-2"}
	offshore_pump_2.placeable_by = {item = "offshore-pump-2", count = 1}
	offshore_pump_2.max_health = 200
	offshore_pump_2.crafting_speed = 1.5
	offshore_pump_2.energy_usage = "1900kW"
	...
	offshore_placeholder_3.minable = {mining_time = 3, result = "offshore-pump-3"}
	offshore_placeholder_3.max_health = 250
	offshore_placeholder_3.pumping_speed = 20
	...
	offshore_pump_3.minable = {mining_time = 3, result = "offshore-pump-3"}
	offshore_pump_3.placeable_by = {item = "offshore-pump-3", count = 1}
	offshore_pump_3.max_health = 250
	offshore_pump_3.crafting_speed = 4
	offshore_pump_3.energy_usage = "3200kW"
	offshore_pump_3.module_specification = {module_slots = 1}
	offshore_pump_3.allowed_effects = {"consumption", "speed", "productivity", "pollution"}
	...
	offshore_placeholder_4.minable = {mining_time = 3, result = "offshore-pump-4"}
	offshore_placeholder_4.max_health = 300
	offshore_placeholder_4.pumping_speed = 35
	...
	offshore_pump_4.minable = {mining_time = 3, result = "offshore-pump-4"}
	offshore_pump_4.placeable_by = {item = "offshore-pump-4", count = 1}
	offshore_pump_4.max_health = 300
	offshore_pump_4.crafting_speed = 8
	offshore_pump_4.energy_usage = "4000kW"
	offshore_pump_4.module_specification = {module_slots = 2}
	offshore_pump_4.allowed_effects = {"consumption", "speed", "productivity", "pollution"}
	...
	offshore_pump_1.minable = {mining_time = 3, result = "offshore-pump-1"}
	offshore_pump_1.placeable_by = {item = "offshore-pump-1", count = 1}
	offshore_pump_1.pumping_speed = 5
	offshore_pump_1.max_health = 150
	data:extend({offshore_pump_1})
	...
	offshore_pump_2.minable = {mining_time = 3, result = "offshore-pump-2"}
	offshore_pump_2.placeable_by = {item = "offshore-pump-2", count = 1}
	offshore_pump_2.pumping_speed = 10
	offshore_pump_2.max_health = 200
	data:extend({offshore_pump_2})
	...
	offshore_pump_3.minable = {mining_time = 3, result = "offshore-pump-3"}
	offshore_pump_3.placeable_by = {item = "offshore-pump-3", count = 1}
	offshore_pump_3.pumping_speed = 20
	offshore_pump_3.max_health = 250
	offshore_pump_3.module_specification = {module_slots = 1}
	offshore_pump_3.allowed_effects = {"consumption", "speed", "productivity", "pollution"}
	data:extend({offshore_pump_3})
	...
	offshore_pump_4.minable = {mining_time = 3, result = "offshore-pump-4"}
	offshore_pump_4.placeable_by = {item = "offshore-pump-4", count = 1}
	offshore_pump_4.pumping_speed = 35
	offshore_pump_4.max_health = 300
	offshore_pump_4.module_specification = {module_slots = 2}
	offshore_pump_4.allowed_effects = {"consumption", "speed", "productivity", "pollution"}
	data:extend({offshore_pump_4})
