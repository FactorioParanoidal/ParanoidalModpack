...
data:extend({
  {
    ...
    minimum_value = 0.1,
    maximum_value = 1,
    order = "[InlaidLampsExtended]_a-a"
  },
  {
    type = "int-setting",
    ...
    minimum_value = 1,
    maximum_value = 100,
    order = "[InlaidLampsExtended]_a-b"
  },
  {
    type = "double-setting",
    ...
    minimum_value = 0.1,
    maximum_value = 1,
    order = "[InlaidLampsExtended]_a-c"
  },
  {
    type = "int-setting",
    ...
    minimum_value = 1,
    maximum_value = 100,
    order = "[InlaidLampsExtended]_a-d"
  },
  {
    type = "double-setting",
    ...
    minimum_value = 0.1,
    maximum_value = 1,
    order = "[InlaidLampsExtended]_a-e"
  },
  {
    type = "int-setting",
    ...
    minimum_value = 1,
    maximum_value = 100,
    order = "[InlaidLampsExtended]_a-f"
  },
  {
    type = "bool-setting",
    ...
    setting_type = "startup",
    default_value = false,
    order = "[InlaidLampsExtended]_a-g"
  }
})
