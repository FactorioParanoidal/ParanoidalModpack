...
Resistances = {
    ...
    Small_Biter = {{
        ...
        type = "physical",
        decrease = 1,
        percent = 5 * NE_Enemies.Settings.NE_Difficulty
    }, {
        type = "impact",
        decrease = 0,
        percent = 0
    ...
    Medium_Biter = {{
        ...
        type = "physical",
        decrease = 6,
        percent = 10 * NE_Enemies.Settings.NE_Difficulty
    }, {
        type = "impact",
        decrease = 4,
        percent = 0
    ...
    Big_Biter = {{
        ...
        type = "physical",
        decrease = 14,
        percent = 15 * NE_Enemies.Settings.NE_Difficulty
    }, {
        type = "impact",
        decrease = 10,
        percent = 0
    ...
    Behemoth_Biter = {{
        ...
        type = "physical",
        decrease = 20,
        percent = 18 * NE_Enemies.Settings.NE_Difficulty
    }, {
        type = "impact",
        decrease = 16,
        percent = 0
    ...
    Spawner = {{
        ...
        type = "acid",
        decrease = 15,
        percent = 12 * NE_Enemies.Settings.NE_Difficulty
    }, {
        type = "poison",
        decrease = 0,
        percent = 12 * NE_Enemies.Settings.NE_Difficulty
