...
if bobmods.warfare.FlyingRobotFrames == true then
  ...
  if data.raw.item["brass-gear-wheel"] then
    ...
    bobmods.lib.tech.add_prerequisite("combat-robotics-2", "zinc-processing")
  else
  ...
  if data.raw.item["nitinol-gear-wheel"] then
    ...
    bobmods.lib.tech.add_prerequisite("combat-robotics-4", "nitinol-processing")
  else
...
if data.raw.recipe["robot-tool-combat-3"] then
  ...
  if data.raw.item["emerald-5"] then
    ...
    bobmods.lib.tech.add_prerequisite("combat-robotics-3", "gem-processing-2")
  end
end
