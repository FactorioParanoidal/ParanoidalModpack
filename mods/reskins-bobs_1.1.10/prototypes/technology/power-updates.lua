...
local technologies = {
    ["bob-steam-engine-1"] = {tier = 1, icon_name = "steam-engine", technology_icon_size = 128, technology_icon_mipmaps = 0},

    -- Nuclear reactors
    ["nuclear-power"] = {tier = 1, prog_tier = 3, icon_name = "nuclear-power", tint = reskins.bobs.nuclear_reactor_index["nuclear-reactor"].tint}, -- t3 reactor
    ["bob-nuclear-power-2"] = {tier = 2, prog_tier = 4, icon_name = "nuclear-power", tint = reskins.bobs.nuclear_reactor_index["nuclear-reactor-2"].tint}, -- t4 reactor
    ["bob-nuclear-power-3"] = {tier = 3, prog_tier = 5, icon_name = "nuclear-power", tint = reskins.bobs.nuclear_reactor_index["nuclear-reactor-3"].tint}, -- t5 reactor
}
