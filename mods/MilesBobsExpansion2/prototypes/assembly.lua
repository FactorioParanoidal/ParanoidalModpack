...
--[[
  {
    ...
    ingredients =
    {
      {type="item", name="assembling-machine-9", amount=1},
    ...
    results = {{type="item", name="assembling-machine-10", amount=1}}
  },
...
--[[
		...
		new_assembler.icon="__MilesBobsExpansion2__/graphics/icons/assembling-machine-8.png"
		new_assembler.crafting_speed="4.50"
		--new_assembler.animation.layers.filename = "__MilesBobsExpansion2__/graphics/assembling-machine/assembling-machine-8.png"
		...
		new_assembler.minable={hardness = 0.2, mining_time = 0.5, results = {{type="item", name="assembling-machine-8", amount=1}}}
        ...
        new_assembler.order="c[assembling-machine-8]"		
		new_assembleritem.icon="__MilesBobsExpansion2__/graphics/icons/assembling-machine-8.png"
		...
		new_assembler.icon="__MilesBobsExpansion2__/graphics/icons/assembling-machine-9.png"
		--new_assembler.animation.layers.filename = "__MilesBobsExpansion2__/graphics/assembling-machine/assembling-machine-9.png"
		...
		new_assembler.minable={hardness = 0.2, mining_time = 0.5, results = {{type="item", name="assembling-machine-9", amount=1}}}
		...
		new_assembler.order="c[assembling-machine-9]"
		new_assembleritem.icon="__MilesBobsExpansion2__/graphics/icons/assembling-machine-9.png"
		data:extend{new_assembleritem}
]]--	
...
--[[
		...
		new_assembler.icon="__MilesBobsExpansion2__/graphics/icons/assembling-machine-10.png"
		...
		new_assembler.energy_usage="2000kW"
		new_assembler.minable={hardness = 0.2, mining_time = 0.5, results = {{type="item", name="assembling-machine-10", amount=1}}}
		...
		new_assembleritem.icon="__MilesBobsExpansion2__/graphics/icons/assembling-machine-10.png"
		data:extend{new_assembleritem}
