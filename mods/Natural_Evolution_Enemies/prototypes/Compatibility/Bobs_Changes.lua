if mods["bobenemies"] then
    ...
    if data.raw["unit-spawner"]["bob-biter-spawner"] then
        ...
        data.raw["unit-spawner"]["bob-biter-spawner"].max_count_of_owned_units = 13 +
                                                                                     (2 *
                                                                                         NE_Enemies.Settings
                                                                                             .NE_Difficulty)
        data.raw["unit-spawner"]["bob-biter-spawner"].max_friends_around_to_spawn = 20 +
                                                                                        (2 *
                                                                                            NE_Enemies.Settings
                                                                                                .NE_Difficulty)
        data.raw["unit-spawner"]["bob-biter-spawner"].spawning_cooldown = {(200 + 100 /
            NE_Enemies.Settings.NE_Difficulty), (100 + 50 / NE_Enemies.Settings.NE_Difficulty)}
        ...
        data.raw["unit-spawner"]["bob-biter-spawner"].healing_per_tick = 0.01 +
                                                                             (0.002 * NE_Enemies.Settings.NE_Difficulty) -- 0.02
    ...
    if data.raw["unit-spawner"]["bob-spitter-spawner"] then
        ...
        data.raw["unit-spawner"]["bob-spitter-spawner"].max_count_of_owned_units = 8 +
                                                                                       (2 *
                                                                                           NE_Enemies.Settings
                                                                                               .NE_Difficulty)
        data.raw["unit-spawner"]["bob-spitter-spawner"].max_friends_around_to_spawn = 13 +
                                                                                          (2 *
                                                                                              NE_Enemies.Settings
                                                                                                  .NE_Difficulty)
        data.raw["unit-spawner"]["bob-spitter-spawner"].spawning_cooldown = {(300 + 100 /
            NE_Enemies.Settings.NE_Difficulty), (100 + 80 / NE_Enemies.Settings.NE_Difficulty)}
        ...
        data.raw["unit-spawner"]["bob-spitter-spawner"].healing_per_tick = 0.01 +
                                                                               (0.002 *
                                                                                   NE_Enemies.Settings.NE_Difficulty) -- 0.02
