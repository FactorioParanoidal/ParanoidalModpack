...
subEnemyNameTable["ne_green_splash_1"][10] = "ne-biter-fastL-" ..
                                                 math.floor(6 + (NE_Enemies.Settings.NE_Difficulty / 2))
...
subEnemyNameTable["Spawner-Breeder"][10] = "ne-biter-breeder-" ..
                                               math.floor(8 + (NE_Enemies.Settings.NE_Difficulty / 2))
...
if not subEnemyNumberTable then
    subEnemyNumberTable = {}
end
