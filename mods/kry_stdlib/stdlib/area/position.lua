...
local Direction = require('__kry_stdlib__/stdlib/area/direction') --[[@as StdLib.Area.Direction]]
local Orientation = require('__kry_stdlib__/stdlib/area/orientation') --[[@as StdLib.Area.Orientation]]
