...
Data {
    ...
    icon = '__nanobots-refined__/graphics/technology/roboport-interface.png',
    icon_size = 256,
    effects = {},
...
Data {
    type = 'item',
    name = 'roboport-interface',
    icon = '__nanobots-refined__/graphics/icons/roboport-interface.png',
    icon_size = 64,
    icon_mipmaps = 1,
...
Data {
    ...
    icon = '__nanobots-refined__/graphics/icons/roboport-interface-cc.png',
    icon_size = 64,
    icon_mipmaps = 1,
    hidden = true,
    subgroup = 'logistic-network',
...
ri_cc.icon = '__nanobots-refined__/graphics/icons/roboport-interface-cc.png'
...
for index, direction in pairs({'north', 'east', 'south', 'west'}) do
    ...
    ri_cc.activity_led_sprites[direction] = {
        filename = '__nanobots-refined__/graphics/entity/roboport-interface/combinator-led-constant-south.png',
        width = 11,
        height = 11,
        frame_count = 1,
        draw_as_glow = true,
...
ri_radar.icon = '__nanobots-refined__/graphics/icons/roboport-interface.png'
...
Data {
    ...
    base_animation = {
        layers = {
            {
                filename = '__nanobots-refined__/graphics/entity/roboport-interface/roboport-interface-base.png',
                scale = 1,
                priority = 'medium',
                width = 128,
                height = 224,
                ...
                shift = {0.5, -2.0},
                hr_version = {
                    filename = '__nanobots-refined__/graphics/entity/roboport-interface/hr-roboport-interface-base.png',
                    scale = 0.5,
                    priority = 'medium',
                    width = 256,
                    height = 448,
            ...
            {
                filename = '__nanobots-refined__/graphics/entity/roboport-interface/roboport-interface.png',
                scale = 1,
                priority = 'medium',
                width = 128,
                height = 224,
                ...
                shift = {0.5, -2.0},
                hr_version = {
                    filename = '__nanobots-refined__/graphics/entity/roboport-interface/hr-roboport-interface.png',
                    scale = 0.5,
                    priority = 'medium',
                    width = 256,
                    height = 448,
            ...
            {
                filename = '__nanobots-refined__/graphics/entity/roboport-interface/roboport-interface-base-shadow.png',
                scale = 1,
                priority = 'medium',
                width = 211,
                height = 224,
                ...
                draw_as_shadow = true,
                hr_version = {
                    filename = '__nanobots-refined__/graphics/entity/roboport-interface/hr-roboport-interface-base-shadow.png',
                    scale = 0.5,
                    priority = 'medium',
                    width = 422,
                    height = 448,
            ...
            {
                filename = '__nanobots-refined__/graphics/entity/roboport-interface/roboport-interface-shadow.png',
                scale = 1,
                priority = 'medium',
                width = 128,
                height = 224,
                ...
                draw_as_shadow = true,
                hr_version = {
                    filename = '__nanobots-refined__/graphics/entity/roboport-interface/hr-roboport-interface-shadow.png',
                    scale = 0.5,
                    priority = 'medium',
                    width = 256,
                    height = 448,
            ...
            {
                filename = '__nanobots-refined__/graphics/entity/roboport-interface/roboport-interface-glow.png',
                scale = 1,
                priority = 'medium',
                width = 128,
                height = 224,
                ...
                draw_as_light = true,
                hr_version = {
                    filename = '__nanobots-refined__/graphics/entity/roboport-interface/hr-roboport-interface-glow.png',
                    scale = 0.5,
                    priority = 'medium',
                    width = 256,
                    height = 448,
