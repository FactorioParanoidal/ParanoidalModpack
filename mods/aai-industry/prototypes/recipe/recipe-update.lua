...
if data.raw.recipe["electronic-circuit"] and not data.raw.recipe["wooden-board"] then
	...
	if wood_version.ingredients then
		util.replace_or_add_ingredient_sub(wood_version, "iron-plate", "wood", 2)
	end
	if wood_version.normal then
		util.replace_or_add_ingredient_sub(wood_version.normal, "iron-plate", "wood", 2)
	end
	if wood_version.expensive then
		util.replace_or_add_ingredient_sub(wood_version.expensive, "iron-plate", "wood", 4)
	end
...
if data.raw.recipe["roboport-door-1"] then
	...
	util.replace_or_add_ingredient(
		data.raw.recipe["roboport-antenna-1"],
		"electronic-circuit",
		"electronic-circuit",
		25
	)
