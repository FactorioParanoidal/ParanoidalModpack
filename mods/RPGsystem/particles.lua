...
function create_electronic_particles(surface, count, position,height_mp)
if not height_mp then height_mp=1 end
    for x=1,count do
        local names={"roboport-metal-particle-big","cable-and-electronics-particle-small-medium", "flying-robot-damaged-explosion-particle","substation-metal-particle-big","car-metal-particle-medium"}
        surface.create_particle({
            position = position,
