...
--  bob_laser_turret{name = "laser-turret", health = 1000, buffer_capacity = "801kJ", input_flow_limit = "4800kW", drain = "24kW", energy_consumption = "800kJ", projectile = "laser", damage_modifier = 2, cooldown = 20, range = 24, tint = white, base_tint = white},
  bob_laser_turret{name = "bob-laser-turret-2", health = 1200, buffer_capacity = "2001kJ", input_flow_limit = "8000kW",  drain = "30kW", energy_consumption = "1000kJ", type = "beam", beam = "bob-laser-beam-sapphire", damage_modifier = 3,   cooldown = 20, range = 26, tint = red,    base = bob_turret_base{type = "laser", tint = yellow}},
  bob_laser_turret{name = "bob-laser-turret-3", health = 1400, buffer_capacity = "3601kJ", input_flow_limit = "12000kW", drain = "36kW", energy_consumption = "1200kJ", type = "beam", beam = "bob-laser-beam-emerald",  damage_modifier = 4.2, cooldown = 20, range = 28, tint = blue,   base = bob_turret_base{type = "laser", tint = yellow}},
  bob_laser_turret{name = "bob-laser-turret-4", health = 1600, buffer_capacity = "5601kJ", input_flow_limit = "16800kW", drain = "42kW", energy_consumption = "1400kJ", type = "beam", beam = "bob-laser-beam-topaz",    damage_modifier = 5.6, cooldown = 20, range = 30, tint = purple, base = bob_turret_base{type = "laser", tint = yellow}},
