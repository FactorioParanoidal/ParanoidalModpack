function tankdroneanimation(scale, tint1, tint2)
      ...
      {
        {
          ...
          direction_count = 64,
          tint = tint1,
          shift = util.by_pixel(scale * -4.5, scale * -10),
          animation_speed = 8,
          max_advance = 1,
          stripes =
          {
          ...
          hr_version = {
            ...
            direction_count = 64,
            tint = tint1,
            shift = util.by_pixel(scale * -4.75, scale * -10),
            animation_speed = 8,
            max_advance = 1,
            stripes =
            {
        ...
        },
        {
          ...
          draw_as_shadow = true,
          direction_count = 64,
          shift = util.by_pixel(scale * 17.5, scale * 7),
          max_advance = 1,
          stripes = util.multiplystripes(2,
          {
           {
          ...
          hr_version =
          {
            ...
            draw_as_shadow = true,
            direction_count = 64,
            shift = util.by_pixel(scale * 17.75, scale * 7),
            max_advance = 1,
            stripes = util.multiplystripes(2,
            {
             {
...
{
  {
    ...
    attack_parameters =
    {
      ...
      animation = tankdroneanimation(0.5, tint_drone_gun, tint_drone_1),
      shell_particle =
      {
        name = "shell-particle",
    ...
    run_animation = tankdroneanimation(0.5, tint_drone_gun, tint_drone_1)
  },
}
)
...
{
  {
    ...
    attack_parameters =
    {
      ...
      source_offset = {0, -0.5},
      damage_modifier = 5,
      animation = tankdroneanimation(0.5, tint_drone_laser, tint_drone_1),
    ...
    run_animation = tankdroneanimation(0.5, tint_drone_laser, tint_drone_1)
  },
}
)
...
{
  {
    ...
    attack_parameters =
    {
      ...
      range = 30,
      min_range = 6,
      animation = tankdroneanimation(0.5, tint_drone_flamethrower, tint_drone_1),
      source_offset = {0, -0.5},
      damage_modifier = 2.5,
    ...
    run_animation = tankdroneanimation(0.5, tint_drone_flamethrower, tint_drone_1)
  },
}
)
...
{
  {
    ...
    attack_parameters =
    {
      ...
      min_range = 30,
      animation = tankdroneanimation(0.5 * 1.5, tint_drone_plasma, tint_drone_1),
      ammo_type =
      {
        type = "projectile",
        category = "combat-robot-laser",
    ...
    run_animation = tankdroneanimation(0.5 * 1.5, tint_drone_plasma, tint_drone_1)
  },
}
)
