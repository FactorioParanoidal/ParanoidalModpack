	...
	{
		{
			type = "item",
			name = "train-limit",
			icon = "__TrainSpeedLimit__/graphics/train-limit-itm.png",
			icon_size = 32,
			subgroup = "transport",
		...
		},
        {
            ...
            icon = "__TrainSpeedLimit__/graphics/train-limit.png",
			icon_size = 32,
            ...
            sprites =
            {
                north =
                {
                    filename = "__TrainSpeedLimit__/graphics/train-limit.png",
                    priority = "high",
                    width = 32,
                    height = 64,
                    shift = {0, -0.8}
        ...
        },
        {
			type = "item",
			name = "train-unlimit",
			icon = "__TrainSpeedLimit__/graphics/train-unlimit-itm.png",
			icon_size = 32,
			subgroup = "transport",
		...
		},
        {
            ...
            icon = "__TrainSpeedLimit__/graphics/train-unlimit.png",
			icon_size = 32,
            flags = {"placeable-neutral", "player-creation"},
            fast_replaceable_group = "railway-sign",
            ...
            sprites =
            {
                north =
                {
                    filename = "__TrainSpeedLimit__/graphics/train-unlimit.png",
                    priority = "high",
                    width = 32,
                    height = 64,
                    shift = {0, -0.8}
