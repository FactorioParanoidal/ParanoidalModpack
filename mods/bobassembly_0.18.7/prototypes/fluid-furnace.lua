...
data:extend(
{
  ...
  },
  {
    ...
    if data.raw["assembling-machine"]["steel-chemical-furnace"] then
      bobmods.lib.recipe.add_result("steel-chemical-furnace-from-fluid-chemical-furnace", {"steel-chemical-furnace", 1})
    else
      bobmods.lib.recipe.add_result("steel-chemical-furnace-from-fluid-chemical-furnace", {"chemical-steel-furnace", 1})
