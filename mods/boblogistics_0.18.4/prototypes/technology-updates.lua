...
bobmods.lib.tech.remove_science_pack("character-logistic-slots-1", "chemical-science-pack")
bobmods.lib.tech.remove_science_pack("character-logistic-slots-2", "chemical-science-pack")
bobmods.lib.tech.remove_science_pack("character-logistic-trash-slots-1", "chemical-science-pack")
