...
-- other
non_return_duct.circuit_wire_connection_points = circuit_connector_definitions["fmf-non-return-duct"].points
non_return_duct.circuit_connector_sprites      = circuit_connector_definitions["fmf-non-return-duct"].sprites
