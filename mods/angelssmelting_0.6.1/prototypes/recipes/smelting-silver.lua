...
data:extend(
{
  ...
  -- SMELTING INTERMEDIATE
  {
    ...
    results =
    {
	  ...
	  {type="item", name="slag", amount=1, probability=0.2}, --DrD
    },
	icon = "__angelssmelting__/graphics/icons/processed-silver.png", --DrD
    icon_size = 32,
  ...
  },
  {
    ...
    results =
    {
      {type="item", name="angels-wire-silver", amount=8}, --DrD 16
    },
    icons = {
      {
        icon = "__angelssmelting__/graphics/icons/wire-silver.png",
