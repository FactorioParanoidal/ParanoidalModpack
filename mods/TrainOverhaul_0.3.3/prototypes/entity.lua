...
nuclear_working_sound = {
  sound =
  {
    filename = "__TrainOverhaul__/sound/idle1.ogg",
    volume = 1.2
  },
  idle_sound = {
    filename = "__TrainOverhaul__/sound/idle1.ogg",
...
base_loco.icon_size = 32
base_loco.icon_mipmaps = nil
...
base_cargo_wagon.icon_mipmaps = nil
...
base_fluid_wagon.icon_mipmaps = nil
