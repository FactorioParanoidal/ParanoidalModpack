...
helmod_icons = {}
helmod_icons["unknown-assembling-machine"]="__helmod-optimized__/graphics/icons/unknown-assembling-machine.png"
helmod_icons["default-assembling-machine"]="__helmod-optimized__/graphics/icons/unknown-assembling-machine.png"
