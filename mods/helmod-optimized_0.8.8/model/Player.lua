...
function Player.getRecipes()
  return Lua_player.force.recipes
end
...
function Player.getTechnologies()
  local technologies = {}
  for _,technology in pairs(Lua_player.force.technologies) do
...
function Player.getTechnology(name)
  local technology = Lua_player.force.technologies[name]
  return technology
end
...
function Player.getRecipe(name)
  return Lua_player.force.recipes[name]
end
