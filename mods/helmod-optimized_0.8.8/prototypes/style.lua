...
function menuIconType(name, icon_row, icon_col, suffix, font, hovered_font_color)
  ...
  default_gui[style_name] = {
    ...
    height = 32,
    scalable = false,
    default_graphical_set = monolithIcon("__helmod-optimized__/graphics/icons/menu_icons.png", 32, 1, {0,0}, {x=icon_col[1],y=(icon_row-1)*32}, {top=0,right=0,bottom=0,left=0}, true),
    hovered_graphical_set = monolithIcon("__helmod-optimized__/graphics/icons/menu_icons.png", 32, 1, {0,0}, {x=icon_col[2],y=(icon_row-1)*32}, {top=0,right=0,bottom=0,left=0}, true),
    hovered_font_color = hovered_font_color,
    clicked_graphical_set = monolithIcon("__helmod-optimized__/graphics/icons/menu_icons.png", 32, 1, {0,0}, {x=icon_col[3],y=(icon_row-1)*32}, {top=0,right=0,bottom=0,left=0}, true),
    disabled_graphical_set = monolithIcon("__helmod-optimized__/graphics/icons/menu_icons.png", 32, 1, {0,0}, {x=icon_col[4],y=(icon_row-1)*32}, {top=0,right=0,bottom=0,left=0}, true)
  }
  if font ~= nil then
...
default_gui["helmod_icon"] = {
  ...
  height = 32,
  scalable = false,
  default_graphical_set = monolithIcon("__helmod-optimized__/graphics/icons/helmod_icon.png", 32, 1, {0,0}, {x=0,y=0}, {top=0,right=0,bottom=0,left=0}, true),
  hovered_graphical_set = monolithIcon("__helmod-optimized__/graphics/icons/helmod_icon.png", 32, 1, {0,0}, {x=0,y=0}, {top=0,right=0,bottom=0,left=0}, true),
  clicked_graphical_set = monolithIcon("__helmod-optimized__/graphics/icons/helmod_icon.png", 32, 1, {0,0}, {x=0,y=0}, {top=0,right=0,bottom=0,left=0}, true),
  disabled_graphical_set = monolithIcon("__helmod-optimized__/graphics/icons/helmod_icon.png", 32, 1, {0,0}, {x=0,y=0}, {top=0,right=0,bottom=0,left=0}, true)
}
...
default_gui["helmod_button_tab"] = {
  ...
  left_padding = 8,
  height = 28,
  default_graphical_set = compositionIcon("__helmod-optimized__/graphics/gui.png", corner_size, {16, 0}),
  hovered_font_color={r=0, g=0, b=0},
  hovered_graphical_set = compositionIcon("__helmod-optimized__/graphics/gui.png", corner_size, {16, 8}),
  clicked_font_color={r=1, g=1, b=1},
  clicked_graphical_set = compositionIcon("__helmod-optimized__/graphics/gui.png", corner_size, {16, 0}),
  disabled_font_color={r=0.5, g=0.5, b=0.5},
  disabled_graphical_set = compositionIcon("__helmod-optimized__/graphics/gui.png", corner_size, {16, 0}),
  pie_progress_color = {r=1, g=1, b=1}
}
...
default_gui["helmod_button_tab_selected"] = {
  ...
  left_padding = 8,
  height = 28,
  default_graphical_set = compositionIcon("__helmod-optimized__/graphics/gui.png", corner_size, {8, 0}),
  hovered_font_color={r=0, g=0, b=0},
  hovered_graphical_set = compositionIcon("__helmod-optimized__/graphics/gui.png", corner_size, {8, 8}),
  clicked_font_color={r=1, g=1, b=1},
  clicked_graphical_set = compositionIcon("__helmod-optimized__/graphics/gui.png", corner_size, {8, 0}),
  disabled_font_color={r=0.5, g=0.5, b=0.5},
  disabled_graphical_set = compositionIcon("__helmod-optimized__/graphics/gui.png", corner_size, {8, 0}),
  pie_progress_color = {r=1, g=1, b=1}
}
...
default_gui["helmod_frame_hidden"] = {
  ...
  {
    type = "composition",
    filename = "__helmod-optimized__/graphics/gui.png",
    priority = "extra-high-no-scale",
...
default_gui["helmod_frame_section"] = {
  ...
  graphical_set = compositionIcon("__helmod-optimized__/graphics/gui.png", corner_size, {24, 8})
}
...
default_gui["helmod_frame_tab"] = {
  ...
  title_bottom_padding = 0,
  title_right_padding = 0,
  graphical_set = compositionIcon("__helmod-optimized__/graphics/gui.png", corner_size, {24, 0})
}
...
default_gui["helmod_button-sorted-none"] = {
  ...
  bottom_padding = 1,
  left_padding = 1,
  default_graphical_set = monolithIcon("__helmod-optimized__/graphics/switch-quickbar.png", 24, 1, {0,0}, {x=0,y=0}, {top=1,right=1,bottom=1,left=1}, false),
  hovered_graphical_set = monolithIcon("__helmod-optimized__/graphics/switch-quickbar.png", 24, 1, {0,0}, {x=72,y=0}, {top=1,right=1,bottom=1,left=1}, false),
  clicked_graphical_set = monolithIcon("__helmod-optimized__/graphics/switch-quickbar.png", 24, 1, {0,0}, {x=0,y=0}, {top=1,right=1,bottom=1,left=1}, false)
}
...
default_gui["helmod_button-sorted-down"] = {
  ...
  bottom_padding = 1,
  left_padding = 1,
  default_graphical_set = monolithIcon("__helmod-optimized__/graphics/switch-quickbar.png", 24, 22/24, {0,0}, {x=48,y=0}, {top=1,right=1,bottom=1,left=1}, false),
  hovered_graphical_set = monolithIcon("__helmod-optimized__/graphics/switch-quickbar.png", 24, 22/24, {0,0}, {x=24,y=0}, {top=1,right=1,bottom=1,left=1}, false),
  clicked_graphical_set = monolithIcon("__helmod-optimized__/graphics/switch-quickbar.png", 24, 22/24, {0,0}, {x=72,y=0}, {top=1,right=1,bottom=1,left=1}, false)
}
...
default_gui["helmod_button-sorted-up"] = {
  ...
  bottom_padding = 1,
  left_padding = 1,
  default_graphical_set = monolithIcon("__helmod-optimized__/graphics/switch-quickbar.png", 24, 1, {0,0}, {x=24,y=0}, {top=1,right=1,bottom=1,left=1}, false),
  hovered_graphical_set = monolithIcon("__helmod-optimized__/graphics/switch-quickbar.png", 24, 1, {0,0}, {x=48,y=0}, {top=1,right=1,bottom=1,left=1}, false),
  clicked_graphical_set = monolithIcon("__helmod-optimized__/graphics/switch-quickbar.png", 24, 1, {0,0}, {x=72,y=0}, {top=1,right=1,bottom=1,left=1}, false)
}
