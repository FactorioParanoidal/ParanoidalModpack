...
function hero_5_detail(flow)
	local detail_flow = local_add_flow(flow,"ht-5-dtf","vertical",nil)
end
function hero_6_detail(flow)
	local detail_flow = local_add_flow(flow,"ht-6-dtf","vertical",nil)
end
function hero_7_detail(flow)
	local detail_flow = local_add_flow(flow,"ht-7-dtf","vertical",nil)
end
function hero_8_detail(flow)
	local detail_flow = local_add_flow(flow,"ht-8-dtf","vertical",nil)
end
function hero_9_detail(flow)
	local detail_flow = local_add_flow(flow,"ht-9-dtf","vertical",nil)
end
