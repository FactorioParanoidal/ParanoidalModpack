	...
	{
		{
			...
			action = "lua", -- ickputzdirwech
			--[[ ORIGINAL: action = "create-blueprint-item", ]]
			localised_name = {"item-name.artillery-targeting-remote"},
			--[[ ORIGINAL: technology_to_unlock = "artillery",
	...
	{
		{
			...
			style = "default",
			--[[ORIGINAL: technology_to_unlock = "railway", ]]
			toggleable = true,
			icon =
			{
	...
	{
		{
			...
			--[[ ORIGINAL: technology_to_unlock = "discharge-defense-equipment",
	...
	{
		{
			...
			--[[ORIGINAL: technology_to_unlock = "electronics", ]]
			action = "lua",
	...
	{
		{
			...
			name = "big-zoom",
			order = "a[big-zoom]",
			--[[ORIGINAL: technology_to_unlock = "optics",]]
			action = "lua",
	...
	{
		{
			...
			--[[ORIGINAL: technology_to_unlock = "orbital-ion-cannon",
...
if mods["MaxRateCalculator"] and data.raw["selection-tool"]["max-rate-calculator"] and settings.startup["max-rate-calculator"].value == true then
	...
	data:extend(
	{
		{
			type = "shortcut",
			--[[ORIGINAL: name = "max-rate-calculator",]]
			name = "max-rate-shortcut", -- ickputzdirwech
...
if mods["aai-programmable-vehicles"] and settings.startup["aai-remote-controls"].value == true then
		...
		{
			{
				...
				--[[ORIGINAL: technology_to_unlock = "automobilism", ]]
				style = "blue",
				icon =
				{
	...
	if data.raw["selection-tool"]["path-remote-control"] then -- ickputzdirwech
		data:extend(
		{
			{
				type = "shortcut",
