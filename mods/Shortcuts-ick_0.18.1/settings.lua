...
-- ickputzdirwech
-- [[ New sections are marked like this: ]]
-- ICKPUTZDIRWECH start
-- ICKPUTZDIRWECH stop
...
data:extend(
{
  ...
  --startup
  {
    ...
    order = "b[artillery]-a" -- ickputzdirwech
  },
  {
    type = "string-setting",
    name = "autogen-color",
    ...
    order = "b[artillery]-b" -- ickputzdirwech
	},
	{
		type = "bool-setting",
		name = "draw-grid",
    ...
    order = "a[basic]-d" -- ickputzdirwech
	},
	{
		type = "bool-setting",
    ...
    order = "a[basic]-c" -- ickputzdirwech
	},
	{
		type = "bool-setting",
    ...
    order = "b[artillery]-c" -- ickputzdirwech
	},
	{
		type = "bool-setting",
		name = "tree-killer",
    ...
    order = "a[basic]-a" -- ickputzdirwech
	},
	{
		type = "bool-setting",
    ...
    order = "b[artillery]-d" -- ickputzdirwech
	},
	{
		type = "bool-setting",
    ...
    order = "a[basic]-b" -- ickputzdirwech
	},
	{
		type = "bool-setting",
		name = "big-zoom",
    ...
    order = "a[basic]-e" -- ickputzdirwech
	},
	{
		type = "bool-setting",
		name = "signal-flare",
    ...
    order = "a[basic]-f" -- ickputzdirwech
	}
})
...
data:extend(
{
  --[[ ORIGINAL:
    ...
    name = "aai-remote-controls", -- ickputzdirwech
    localised_description = {"", {""}, "Disable specific shortcuts to free up space for other modded shortcuts, or to slightly increase performance and load time."},
		setting_type = "startup",
    --[[ ORIGINAL:
		default_value = false,
    ...
    default_value = true, -- ickputzdirwech
    order = "d[mods]-c" -- ickputzdirwech
	},
  --[[ ORIGINAL:
	{
		type = "bool-setting",
  ...
  --[[ORIGINAL:
    ...
    order = "c[equipment]-c" -- ickputzdirwech
	},
	{
		type = "bool-setting",
    ...
    order = "c[equipment]-a" -- ickputzdirwech
	},
	{
		type = "bool-setting",
    ...
    order = "c[equipment]-b" -- ickputzdirwech
	}
})
