...
if mods["FARL"] then
  ...
  if loco then
    ...
    -- loco.max_power = multiply_energy_value("2500kW", settings.startup["train-overhaul-power-multiplicator"].value)
    loco.max_power = (2500000 * settings.startup["train-overhaul-power-multiplicator"].value).."W"
