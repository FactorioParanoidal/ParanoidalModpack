...
OV.disable_recipe({ "cobalt-oxide", "cobalt-oxide-from-copper" --, --DrD
 --"cobalt-plate", --DrD
 --"cobalt-steel-alloy" --DrD
 })
...
--OV.disable_recipe({ "bob-zinc-plate", "brass-alloy", "gunmetal-alloy" }) --DrD

--MORE UNLOCKS
-- OV.remove_unlock( "alloy-processing-1", "mixing-furnace" ) --DrD
-- OV.add_unlock( "electronics", "mixing-furnace" ) --DrD
...
--	OV.disable_recipe({ "solder-alloy" })--DrD
...
OV.patch_recipes({
	...
	normal = { ingredients = { { name = "tin-ore", type = "item", amount = "+3" } }, results = { { name = "tin-plate", type = "item", amount = "+1" } } },
...
{ name = "lead-plate",
energy_required = 10.5,
normal = { ingredients = { { name = "lead-ore", type = "item", amount = "+3" } }, results = { { name = "lead-plate", type = "item", amount = "+1" } } },
...
{ name = "quartz-glass",
energy_required = 10.5,
normal = { ingredients = { { name = "quartz", type = "item", amount = "+3" } }, results = { { name = "glass", type = "item", amount = "+1" } } },
...
{ name = "silver-plate",
energy_required = 10.5,
normal = { ingredients = { { name = "silver-ore", type = "item", amount = "+3" } }, results = { { name = "silver-plate", type = "item", amount = "+1" } } },
...
--OV.disable_recipe({ "bronze-alloy" }) --DrD
