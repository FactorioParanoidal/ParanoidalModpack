...
data:extend({
{
	...
	filename = "__shield-projector__/graphics/entity/shield-projector/shield/wall-south.png",
    scale = 0.5,
    animation_speed = 0.3,
    frame_count = 24,
    width = 2816/4,
...
data:extend({
...

  {
    ...
    flags = {"placeable-player", "player-creation", "hide-alt-info"},  --"not-blueprintable"
...

  {
    ...
    results ={{type="item", name="hs_holo_sign", amount=1}}
  },
})
