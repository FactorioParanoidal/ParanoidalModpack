...
--###############################################################################################
{
    ...
    icon = "__zzzparanoidal__/graphics/Platinum_Sorting/platinum-sorting.png",
    icon_size = 32,
...
--###############################################################################################
{
    ...
    icon = "__zzzparanoidal__/graphics/Manganese_Chrome_Sorting/manganese-sorting.png",
    icon_size = 32,
    subgroup = "angels-ore-sorting-advanced",
    order = "e-a",
...
--###############################################################################################
{
    ...
    icon = "__zzzparanoidal__/graphics/Manganese_Chrome_Sorting/chrome-sorting.png",
    icon_size = 32,
    subgroup = "angels-ore-sorting-advanced",
    order = "o-a",
    category = "angels-ore-sorting-3",
