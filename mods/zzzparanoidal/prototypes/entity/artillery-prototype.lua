	...
	artillery_turret_prototype,
	{
		...
		attack_parameters = {
			...
			projectile_creation_parameters = require(
				"__base__.prototypes.entity.artillery-cannon-muzzle-flash-shifting"
			),
			sound = {
				{
					filename = "__zzzparanoidal__/graphics/sound/artillery-shoots.ogg",
					volume = 0.7,
				},
			},
			shell_particle = {
