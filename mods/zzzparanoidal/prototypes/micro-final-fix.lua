...
data.raw["item"]["bio-hatchery-2"].localised_description = "Уютное место, где могут вылупляться яйца фугу."
data.raw["item"]["bio-hatchery-3"].localised_description = "Уютное место, где могут вылупляться яйца фугу."
