...
data.raw["roboport"]["bob-roboport-2"].logistics_radius = 64
data.raw["roboport"]["bob-roboport-2"].construction_radius = 128

data.raw["roboport"]["bob-roboport-3"].logistics_radius = 96
data.raw["roboport"]["bob-roboport-3"].construction_radius = 192

data.raw["roboport"]["bob-roboport-4"].logistics_radius = 128
data.raw["roboport"]["bob-roboport-4"].construction_radius = 256
