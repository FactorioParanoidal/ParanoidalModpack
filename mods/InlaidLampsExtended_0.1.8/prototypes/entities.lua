...
data:extend({
    ...
    -- 2x2 Flat Lamp Entity
    {
        ...
        -- RGB Red (251, 30, 10)
        light = {intensity = light_intensity, size = 2 * light_size, color = {r=1.0, g=1.0, b=1.0}},
        light_when_colored = {intensity = light_colored_intensity, size = 2 * light_colored_size, color = {r=1.0, g=1.0, b=1.0}},
        glow_size = loc_glow_size,
        glow_color_intensity = loc_glow_color_intensity,
        darkness_for_all_lamps_on = loc_darkness_for_all_lamps_on,
        darkness_for_all_lamps_off = loc_darkness_for_all_lamps_off,
