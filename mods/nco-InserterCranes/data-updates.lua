...
if mods["boblogistics"] then
	register_crane("bob-red-bulk-inserter", "nco-red-wide-crane", true, nil)
	register_crane("bob-red-bulk-inserter", "nco-red-crane", false, nil)

	register_crane("bob-turbo-bulk-inserter", "nco-wide-turbo-crane", true, nil)
