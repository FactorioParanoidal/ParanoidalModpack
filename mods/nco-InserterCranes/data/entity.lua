...
local function calculate_performance(entity, wide, forced_ips)
	...
	local energy_scale = (new_stack_size_bonus / max_stack_size_bonus)
		* (entity.rotation_speed / performance.rotation_speed)
		* ((wide and 16) or 4.5)
		* 1.75
...
local function make_crane_entity(entityName, newName, wide, forced_ips)
	...
	if #newSheets > 0 then
		...
		if wide then
			table.insert(entity.platform_picture.sheets, {
