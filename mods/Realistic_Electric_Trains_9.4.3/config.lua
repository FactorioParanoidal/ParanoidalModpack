...
config = {
	...
	advanced_locomotive_power = 1800000,
	advanced_locomotive_storage = store(3600000),
	-- Modular Locomotive (1.8MW, three times vanilla)
	modular_locomotive_base_power = 2600000,
	modular_locomotive_storage = store(5200000)
}
