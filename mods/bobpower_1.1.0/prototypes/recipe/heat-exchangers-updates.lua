...
if data.raw.item["heat-pipe-3"] then
  ...
  if settings.startup["bobmods-plates-convert-recipes"] and settings.startup["bobmods-plates-convert-recipes"].value == true then
    ...
    bobmods.lib.tech.add_recipe_unlock("bob-boiler-3", "boiler-3-from-heat-exchanger")
    bobmods.lib.tech.add_recipe_unlock("bob-boiler-4", "boiler-4-from-heat-exchanger-2")
    bobmods.lib.tech.add_recipe_unlock("bob-boiler-5", "boiler-5-from-heat-exchanger-3")
  end
