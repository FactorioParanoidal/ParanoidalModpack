...
для Factorio 2.0.77 (протестировано) и выше.  
*DLC Space Age и Factorio 2.1 не поддерживается на данный момент.*

На данный момент в активной разработке.
Стабильная сборка для Factorio 1.1 [тут](https://github.com/FactorioParanoidal/ParanoidalModpack/tree/factorio1.1)
...
> [!NOTE]  
> На текущий момент сборка НЕ СОВМЕСТИМА с Space Age и Quality. При первом запуске вы увидите предупреждение о несовместимости модов и предложением отключить space-age и quality - отключайте.

- Релизная версия, установщик / ручной  
  На текущий момент релизная версия - предыдущая версия сборки под Factorio 1.1. Все способы установки описаны в [ветке 1.1](https://github.com/FactorioParanoidal/ParanoidalModpack/tree/factorio1.1#%D0%BA%D0%B0%D0%BA-%D0%BD%D0%B0%D1%87%D0%B0%D1%82%D1%8C)
- Дэв-версия, ручной  
  1. Установить последнюю доступную версию Factorio. Рекомендуется ***2.0.77*** или новее (официальная версия/репак с [рутрекера](https://rutracker.org/forum/viewtopic.php?t=5930062)).  
