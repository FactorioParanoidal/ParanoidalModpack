...
для Factorio 2.0.69 (протестировано) и выше.  
...
- [Проверка обновлений модов](tools/check_updates.md) - скрипт сверки версий сборки с Mod Portal
...
- Установщик, стабильная версия (для Factorio 1.1)
...
- Ручной, стабильная версия (для Factorio 1.1)
  Другие способы описаны в [ветке 1.1](https://github.com/FactorioParanoidal/ParanoidalModpack/tree/factorio1.1#%D0%BA%D0%B0%D0%BA-%D0%BD%D0%B0%D1%87%D0%B0%D1%82%D1%8C)
- Ручной, версия в разработке
  1. Установить последнюю доступную версию Factorio. Рекомендуется ***2.0.69*** или новее (официальная версия/репак с [рутрекера](https://rutracker.org/forum/viewtopic.php?t=5930062)).  
  ...
  3. Загрузить сборку
     - ~~Релизная версия~~
       ...
       Релизных версий под Factorio 2.0 пока не выпущено
