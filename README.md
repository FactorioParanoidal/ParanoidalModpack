...
для Factorio 1.1.91 (протестировано) и выше
...
- Установщик (стабильная версия)
  ...
  3. Играть (не забудьте ознакомиться с [Рекомендациями к старту](https://gitlab.com/paranoidal/modpack/-/wikis/Recommendations) и [FAQ](https://gitlab.com/paranoidal/modpack/-/wikis/FAQ))
...
- Ручной (последняя альфа-версия)
  1. Установить последнюю доступную версию Factorio. Рекомендуется ***1.1.91*** или новее (официальная версия/репак с [рутрекера](https://rutracker.org/forum/viewtopic.php?t=5930062))
  ...
  5. Играть (не забудьте ознакомиться с [Рекомендациями к старту](https://gitlab.com/paranoidal/modpack/-/wikis/Recommendations) и [FAQ](https://gitlab.com/paranoidal/modpack/-/wikis/FAQ))
