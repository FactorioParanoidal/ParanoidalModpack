...
для Factorio 2.0.76 (протестировано) и выше.  
...
- Ручной, версия в разработке
  1. Установить последнюю доступную версию Factorio. Рекомендуется ***2.0.76*** или новее (официальная версия/репак с [рутрекера](https://rutracker.org/forum/viewtopic.php?t=5930062)).  
