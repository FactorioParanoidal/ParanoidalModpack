...
- Ручной (последняя альфа-версия)
  1. Установить последнюю доступную версию Factorio. Рекомендуется ***1.1.74*** или новее (официальная версия/репак с [рутрекера](https://rutracker.org/forum/viewtopic.php?t=5930062))
